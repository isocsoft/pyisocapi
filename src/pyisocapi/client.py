...
class IsocapiClient:
    ...
    def __response_handling(
        ...
        bad_req_exception_msg: str,
    ) -> niquests.Response:
        match resp.status_code:
            case 200:
                return resp
            case 400:
                raise BadRequestError(bad_req_exception_msg)
            case 402:
    ...
    def get_olx_by_url(self, url: str) -> IsocapiAPIResponse:
        ...
        resp = self.__response_handling(
            resp, bad_req_exception_msg=OLX_BY_URL_BAD_URL_PASSED_ERR_MSG(url)
        )
    ...
    def get_olx_by_query(self, query: str, page: int) -> IsocapiAPIResponse:
        ...
        # resp = self.__response_handling(resp, OLX_BY_QUERY_??)
